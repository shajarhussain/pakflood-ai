...
from app.routes import health, prediction, boundaries, flood_events, zones, districts, chat, weather, auth, rivers
...
router.include_router(rivers.router,  tags=["rivers"])
